...
public class WallFollowingEnemy extends NonTargetingEnemy {
	...
	/**
	 * The constructor of WallFollowingEnemy. Sets attributes based on information
	 * read from file.
	 * 
	...
	public WallFollowingEnemy(String name, Cell[][] mapActual, int[] info) {
		...
		/*
		 * Checking for which direction enemy will initially face info[2] is either:
		 * 1,2,3 or 4 up = 1, down = 2, right = 3, left = 4
		 */
		switch (info[2]) {
		case 1:
			super.facing = 'u';
	...
	public void moveY(int xLocation, int yLocation, char facing) {
		...
		/*
		 * When no walls surround Wall Following Enemy, Move towards a wall it's facing.
		 */
	...
	public void moveX(int xLocation, int yLocation, char facing) {
		...
		if (this.facing == 'l') {
			...
			// If enemy is facing right, check surrounding cells and move based on this
			// check
