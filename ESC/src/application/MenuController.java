...
/**
 * This class controls the menu, and all the actions that can be done within it
 */
...
public class MenuController {
	...
	@FXML
	private Button leaderboardLevel1Button;
	@FXML
	private Button leaderboardLevel2Button;
	@FXML
	private Button leaderboardLevel3Button;
	@FXML
	private Button leaderboardLevel4Button;
	@FXML
	private Button leaderboardLevel5Button;
	@FXML
	private Button leaderboardButton;
	@FXML
	private Button backButton;
	@FXML
	private MenuButton profilesMenu;
	@FXML
	private MenuButton levelSelectMenu;
	@FXML
	private MenuItem profile1MenuItem;
	@FXML
	private MenuItem profile2MenuItem;
	@FXML
	private MenuItem profile3MenuItem;
	@FXML
	private MenuItem profile4MenuItem;
	@FXML
	private MenuItem profile5MenuItem;
	@FXML
	private MenuItem level1MenuItem;
	@FXML
	private MenuItem level2MenuItem;
	@FXML
	private MenuItem level3MenuItem;
	@FXML
	private MenuItem level4MenuItem;
	@FXML
	private MenuItem level5MenuItem;
	@FXML
	private TextField profileNameBox;

	/**
	 * Runs when the menu is opened. Gets profiles from the Profiles.txt. Displays
	...
	/**
	 * Gets profiles from a text file. Displays them as MenuItems in the
	 * profilesMenu.
	 */
